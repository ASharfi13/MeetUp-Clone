        ...
        <div className="landRoot">
            ...
            <div className="LandingSubLinks">
                <div className="SubLink">
                    ...
                    <p className="linkDescription">Whether you{'\''}re an Air-Bender! A talking blue Cat with a Goldfish friend! Or the Grim Reaper! Come find the Cartoon World you want to explore!</p>
                </div>
                <div className="SubLink">
                    <img className="linkImage2" src={regularshow} alt="Regular Show Events logo"></img>
                    <Link className="linkText" to='/events'>Find An Event</Link>
                    <p className="linkDescription">Down for a one on one in Mystical Basketball? An Adventure across the Land of Ooo? A lab party at Dexter{'\''}s? Click and Search through more Awesome Events!</p>
                </div>
                <div className="SubLink">
                    <img className="linkImage3" src={ben10} alt="Gumball Start Logo"></img>
                    {user !== null ? (<Link className="linkText" to={'/groups/new'} >Start A World</Link>) : (<h1 className="linkText" style={{ fontWeight: 400, color: 'grey' }}>Start A World</h1>)}
                    <p className="linkDescription">Everyone loves a good crossover! Have you ever imagined Gumball, Finn, and Ben10 launching an epic battle against Vilgax! Click and Create that World Now!</p>
                </div>
            </div>
